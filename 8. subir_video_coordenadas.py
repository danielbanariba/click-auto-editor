        ...
        if filename.endswith('.mp4'):
            ...
            for txt_filename in filenames:
                if txt_filename.endswith('.txt'):
                    ...
                    base_date = datetime(2027, 1, 15)  # Fecha específica: 12 de Enero del 2027
                    ...
                    while True:
                        random_hour = random.randint(9, 14)  # Genera un número aleatorio entre 9 y 14
                        random_minute = random.choice([0, 15, 30, 45])  # Elige un número aleatorio de la lista [0, 15, 30, 45]
                        if not (random_hour == 0 and random_minute == 0):
                            break
